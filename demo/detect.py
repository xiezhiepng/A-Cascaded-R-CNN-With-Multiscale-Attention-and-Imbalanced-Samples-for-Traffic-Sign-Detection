...
#cctsdb
#config_file = '../configs/libra_rcnn/GTSDB/2_cascade_rcnn_r50_fpn_1x.py'
#checkpoint_file = '../work_dirs/BestResult/epoch_3.pth'

config_file = '../configs/libra_rcnn/GTSDB/1_cascade_rcnn_r50_fpn_1x.py'
checkpoint_file = '../work_dirs/1_cascade_rcnn_r50_fpn_1x/epoch_12.pth'
